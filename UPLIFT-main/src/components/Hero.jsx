...
//         >
//           {/* UPDATED: Changed from indigo to violet */}
//           <button 
//             // Updated to scroll to contact section
//             onClick={() => document.getElementById('contact').scrollIntoView({ behavior: 'smooth' })} 
//             className="group bg-violet-600 hover:bg-violet-700 px-8 py-3 rounded-md font-medium transition-all flex items-center gap-2"
//           >
//             Let&apos;s Work Together
    ...
    >
      ...
      <div className="text-center max-w-5xl mx-auto space-y-8">
        ...
        <div 
          ...
          style={{ animationDelay: '0.6s' }}
        >
          {/* UPDATED: "Let's Work Together" button removed */}
          <button 
            // Updated to scroll to services section
            onClick={() => document.getElementById('services').scrollIntoView({ behavior: 'smooth' })} 
            className="bg-transparent border border-white/20 hover:border-white/40 px-8 py-3 rounded-md font-medium transition-all"
